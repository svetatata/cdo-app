<?php 
$pageTitle = 'Контакты';
$metaDescription = 'Контактная информация Idea Teach. Адрес, телефон, email, режим работы и форма обратной связи. Свяжитесь с нами любым удобным способом.';
$metaKeywords = 'контакты, адрес, телефон, email, режим работы, обратная связь, как связаться, социальные сети';
?>
